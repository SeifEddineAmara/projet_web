...
class InscriptionController extends AbstractController
{
    ...
    /**
     * @Route("/{idInscription}", name="app_inscription_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idInscription}/edit", name="app_inscription_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idInscription}", name="app_inscription_delete", methods={"POST"})
     */
    public function delete(Request $request, Inscription $inscription, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$inscription->getIdInscription(), $request->request->get('_token'))) {
